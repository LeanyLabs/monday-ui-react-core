...
<UsageGuidelines guidelines={[
  "Use checkboxes to: 1) Select one or more options from a list Turn an item on or off in a desktop environment",
  ...
  rules={[
    {
      positive: {
        ...
        <DialogContentContainer className="monday-style-story-checkbox_wrapper">
            ...
            <Checkbox label="Item 3" checked={true} />
      ...
      negative: {
        component: <DialogContentContainer className="monday-style-story-checkbox_wrapper">
            ...
            <Checkbox label="Item 2" disabled={true} />
            <Checkbox label="Item 3" disabled={true} />
          </DialogContentContainer>,
    ...
    {
      positive: {
        component:<div className="monday-style-story-checkbox_border"><Checkbox label="Option" checked={true}/></div>,
        description:"Use the checkbox label’s prop to describe the option purpse."
      },
      negative: {
        component: [
          <div className="monday-style-story-checkbox_border"><Checkbox checked={true}/></div>,
    ...
    },
    {
      ...
      negative: {
        component: 
          <DialogContentContainer className="monday-style-story-checkbox_wrapper">
            <div className="monday-style-story-checkbox_inline-wrapper"><span>Item 1</span><Checkbox /> </div>
            <div className="monday-style-story-checkbox_inline-wrapper"><span>Item 2</span><Checkbox checked={true} /> </div>
            <div className="monday-style-story-checkbox_inline-wrapper"><span>Item 3</span><Checkbox checked={true} /> </div>
          </DialogContentContainer>,
...
<Canvas>
  <Story name="Single checkbox">
    <Checkbox checked label="I agree to the Terms of Service and Privacy Policy." />
  </Story>
</Canvas>
