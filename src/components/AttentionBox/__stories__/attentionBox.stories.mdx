...
<Canvas>
  <Story name="Overview"
         args={ {title: "Attention box title", text: "Studies show that 100% of people who celebrate birthdays, will eventually die.", componentClassName: "monday-style-attention-box_box"} }>
...
<Canvas>
  <Story name="States">
    <MultipleStoryElementsWrapper className="monday-style-attention-box_column-wrapper">
      <AttentionBox title="Primary" text="Lorem Ipsum is simply dummy text of the printing and typesetting industry." componentClassName="monday-style-attention-box_box" />
      <AttentionBox title="Success" text="Lorem Ipsum is simply dummy text of the printing and typesetting industry." type={ATTENTION_BOX_TYPES.SUCCESS} componentClassName="monday-style-attention-box_box" />
      <AttentionBox title="Danger" text="Lorem Ipsum is simply dummy text of the printing and typesetting industry." type={ATTENTION_BOX_TYPES.DANGER} componentClassName="monday-style-attention-box_box" />
      <AttentionBox title="Dark" text="Lorem Ipsum is simply dummy text of the printing and typesetting industry." type={ATTENTION_BOX_TYPES.DARK} componentClassName="monday-style-attention-box_box" />
...
<Canvas>
  <Story name="Dismissable ">
    <div className="monday-style-attention-box_row-wrapper">
      <AttentionBox title="Regular attention box" text="Dismissable attention box with two lines of content." onClose componentClassName="monday-style-attention-box_box" />
      <AttentionBox text="Attention box in compact mode" onClose compact componentClassName="monday-style-attention-box_box" />
    </div>
  </Story>
</Canvas>
...
<ComponentRules
  rules={[
    {
      positive: {
        component:<AttentionBox title="Attention box title" text="Studies show that 100% of people who celebrate birthdays, will eventually die." componentClassName="monday-style-attention-box_box"/>,
      ...
      positive: {
        component:
          <div>
            ...
            <AttentionBox text={<span className="monday-style-attention-box_info">Get your monday.com notifications<Link>Learn More</Link></span>} componentClassName="monday-style-attention-box_att-box"  />
          </div>,
      ...
      negative: {
        component:
          <div>
            <span className="monday-style-attention-box_title">Inbox</span>
            <span className="monday-style-attention-box_text" >Catch up on updates from all your boards.</span>
            <AttentionBox text={<span className="monday-style-attention-box_info">7 days left on your free trial <Link>Learn More</Link></span>} compact componentClassName="monday-style-attention-box_att-box" />
          </div>,
