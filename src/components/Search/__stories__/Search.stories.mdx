...
<Tip title="Not what you were looking for?">If you need to filter results from a long list, consider using the<Link href="/?path=/docs/components-combobox--overview" size={Link.sizes.SMALL}>Combobox</Link>component.</Tip>
...
<Tip title="Missing something?">If you’re looking for search states, go to<Link href="/?path=/docs/components-canvas--overview" size={Link.sizes.SMALL}>Canvas</Link>and play with Knobs.</Tip>
