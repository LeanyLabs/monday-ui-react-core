...
import { TOOLTIP, LABEL, CHIPS } from "../../../storybook/components/related-components/component-description-map";
...
## Related components
<RelatedComponents componentsNames={[TOOLTIP, LABEL, CHIPS]}/>
