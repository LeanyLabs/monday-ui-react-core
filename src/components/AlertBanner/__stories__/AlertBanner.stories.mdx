...
<Canvas>
  <Story name="Overview"
         args={ {bannerText: "Alert banner message", linkText: "this is a CTA", className: "container"} }>
...
<ComponentRules
  rules={[
    ...
    },
    {
      ...
      negative: { 
        component:
          <AlertBanner backgroundColor={AlertBanner.backgroundColors.PINK} className="medium-container pink">
            <AlertBannerText text="Join us at Elevate!" />
            <AlertBannerLink text="RSVP now" href="https://monday.com" />
          </AlertBanner>,
