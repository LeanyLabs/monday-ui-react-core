...
<Tip title="Not what you were looking for?">If you need to use icon as button with no text, check out <Link href="/?path=/docs/components-buttons-icon-button--overview" size={Link.sizes.SMALL} withoutSpacing>Icon button</Link> component</Tip>
