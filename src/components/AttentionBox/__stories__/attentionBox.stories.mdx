...
import { TOOLTIP, ALERT_BANNER, LABEL } from "../../../storybook/components/related-components/component-description-map";
      ...
      positive: {
        component:
          <div>
            ...
            <AttentionBox text={<span className="monday-style-attention-box_info">Get your monday.com notifications<Link>Learn More</Link></span>} componentClassName="att-box"  />
          </div>,
      ...
      negative: {
        component:
          <div>
            <span className="monday-style-attention-box_title">Inbox</span>
            <span className="monday-style-attention-box_text" >Catch up on updates from all your boards.</span>
            <AttentionBox text={<span className="monday-style-attention-box_info">7 days left on your free trial <Link>Learn More</Link></span>} compact componentClassName="att-box" />
          </div>,
...
## Related components
<RelatedComponents componentsNames={[ALERT_BANNER, TOOLTIP, TOOLTIP]} />