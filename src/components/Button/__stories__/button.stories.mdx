...
import { BUTTON_GROUP, SPLIT_BUTTON, CHIPS } from "../../../storybook/components/related-components/component-description-map";
...
<Tip title="Not what you were looking for?">If you need to use icon as button with no text, check out <a href="/docs/components-buttons-icon-button--overview">Icon button</a> component</Tip>
...
## Related components
<RelatedComponents componentsNames={[SPLIT_BUTTON, BUTTON_GROUP, CHIPS]}/>