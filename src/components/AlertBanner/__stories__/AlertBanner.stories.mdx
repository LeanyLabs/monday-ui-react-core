...
<Canvas>
  <Story name="Overview"
         args={ {bannerText: "Alert banner message", linkText: "this is a CTA", className: "monday-storybook-alert-banner_container"} }>
...
<Canvas>
  <Story name="Alert banner as an announcement">
    <AlertBanner backgroundColor={AlertBanner.backgroundColors.DARK} className="monday-storybook-alert-banner_container">
