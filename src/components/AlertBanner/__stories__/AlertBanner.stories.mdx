  ...
  rules={[
    {
      positive: {
        component:
          <AlertBanner className="medium-container">
      ...
      negative: {
        ...
        description:<>Don’t use banners for notifying a user of an action they have taken. Instead, provide visual feedback with a <Link href="/?path=/docs/components-toast--overview">Toast.</Link></>
      }
    },
    {
      positive: {
        component:
          <AlertBanner className="medium-container" backgroundColor={AlertBanner.backgroundColors.NEGATIVE}>
    ...
    },
    {
      positive: {
        component:
          <AlertBanner backgroundColor={AlertBanner.backgroundColors.DARK} className="medium-container">
            <AlertBannerText text="Join us at Elevate!" />
            <AlertBannerLink text="RSVP now" href="https://monday.com" />
          </AlertBanner>,
      ...
      negative: { 
        component:
          <AlertBanner backgroundColor={AlertBanner.backgroundColors.PINK} className="medium-container">
            <AlertBannerText text="Join us at Elevate!" />
            <AlertBannerLink text="RSVP now" href="https://monday.com" />
          </AlertBanner>,
