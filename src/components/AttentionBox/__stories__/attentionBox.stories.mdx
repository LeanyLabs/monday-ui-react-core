  ...
  <Story name="States">
    <MultipleStoryElementsWrapper className="monday-style-attention-box_column-wrapper">
      ...
      <AttentionBox 
        title="Danger" 
        text="Lorem Ipsum is simply dummy text of the printing and typesetting industry." 
        type={ATTENTION_BOX_TYPES.DANGER} className="monday-style-attention-box_box" 
      />
      <AttentionBox 
        title="Dark" 
        text="Lorem Ipsum is simply dummy text of the printing and typesetting industry." 
        type={ATTENTION_BOX_TYPES.DARK} className="monday-style-attention-box_box" 
      />
...
<Canvas>
  <Story name="Natural attention box">
    <div className="monday-style-attention-box_wrapper">
      ...
      <AttentionBox 
        text={
          <div className="monday-style-attention-box_inline-wrapper">
