...
import { TOGGLE, CHECKBOX, CHIPS } from "../../../storybook/components/related-components/component-description-map";
...
## Related components
<RelatedComponents componentsNames={[CHECKBOX, CHECKBOX, CHIPS]} />