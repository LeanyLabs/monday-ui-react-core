...
<Canvas>
  <Story name="Toast with link">
    <Toast open className="monday-storybook-toast_wrapper" actions={[{ type: Toast.actionTypes.LINK, text: "Link to action", href: "https://monday.com" }]}>General message toast</Toast>
  </Story>
</Canvas>
