...
<Tip title="Am I using the right component?">For settings that are immediately applied, consider using a <Link href="#" size={Link.sizes.SMALL} withoutSpacing>toggle switch</Link> instead.</Tip>
