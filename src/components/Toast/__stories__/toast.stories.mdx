...
<Canvas>
  <Story name="Default with button">
    <Toast open className="monday-storybook-toast_wrapper" actions={[{ type: Toast.actionTypes.BUTTON, content: "Button" }]}>General mdessage toast</Toast>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Toast with link">
    <Toast open className="monday-storybook-toast_wrapper" actions={[{ type: Toast.actionTypes.LINK, text: "Link to action", href: "https://monday.com" }]}>General mdessage toast</Toast>
  </Story>
</Canvas>
...
<ComponentRules
  rules={[
    {
      positive: {
        component:<Toast open className="monday-storybook-toast_wrapper" type={Toast.types.POSITIVE}>Duplicating Board</Toast>,
        ...
        component:
          <div className="monday-storybook-toast_inline-wrapper">
            <Toast 
              ...
              hideIcon 
              closeable={false}
              className="monday-storybook-toast_wrapper big"
...
<Canvas>
  <Story name="Feedback loop">
    <Toast className="monday-storybook-toast_wrapper" open type={Toast.types.POSITIVE} actions={[{ type: Toast.actionTypes.BUTTON, content: "Undo 5" }]}>Negative message toast</Toast>
  </Story>
</Canvas>
