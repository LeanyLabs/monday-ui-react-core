...
<Tip title="Am I using the right component?">For settings that are immediately applied, consider using a toggle switch instead.</Tip>
  ...
  rules={[
    {
      ...
      negative: {
        ...
        description:"Don't use checkboxes when only one item can be selected from a list. Use radio buttons instead."
      }
    },
    {
      positive: {
